...
def _bind_module_symbols() -> None:
    ...
    global build_call_graph, clear_call_graph_cache, _collect_local_imports
    ...
    clear_call_graph_cache = _cg.clear_call_graph_cache
...
def create_app(root: Path | None = None) -> FastMCP:
    ...
    def set_workspace_root(path: str) -> dict[str, Any]:
        ...
        try:
            ...
            working_set.clear()
            tracker = WorkflowTracker.from_plan(module_plan)
            last_workflow_snapshot = None
            last_workflow_next_tool = None
            clear_call_graph_cache()
